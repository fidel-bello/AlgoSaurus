        ...
        <CustomAccordionItem
          ...
          bodyHTML={
            <p>
              ...
              loops are faced with confusion and a lot end up giving up on their
              dreams. So we decided to make AlgoSaurus, an algorithm visualizing
              platform in order to help newer programmers grasp a better
        ...
        <CustomAccordionItem
          ...
          bodyHTML={
            <p>
              ...
              challenge. Each algorithm has its own individual code and its own
              number of indexes that are being manipulated, making it almost
              mandatory to understand the loop.
            </p>
          }
        />
        <CustomAccordionItem
          ...
          bodyHTML={
            <p>
              ...
              project up and running as a team. We are all excited and proud to
              have worked together so flawlessly. Collaboration is key in these
              types of projects and we could not be any happier with the
              results. While we are finished for the hackathon, this project can
              be something we can keep building on and improving as a team.
            </p>
          }
        />
        <CustomAccordionItem
          ...
          bodyHTML={
            <p>
              ...
              everyone&apos;s unique tricks on working on a problem were amazing
              to see. We also learned so much more from going around to
              different tables and talking to them about their project and
              looking at how they do things. But, above all, we all learned how
              to work as a team. We all worked extremely hard and communication
        ...
        <CustomAccordionItem
          ...
          bodyHTML={
            <p>
              ...
              educative system. Computer programming is hot on the market right
              now, and with new programmers coming in every day, the need for an
              educative system that aids these new programmers is a must. We
              definitely see AlgoSaurus being a scalable project. Adding
              authentication and log-in system, including more algorithms, and
              possibly even adding a matching tutoring system or live chat are
              ideas that are all being thought of by us.
            </p>
          }
        />
        <CustomAccordionItem
